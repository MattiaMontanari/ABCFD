...
%   IFISS scriptfile: DJS; 30 April 2012. 
...
if domain ==3, eplotl(error_tot,mv,xy,x,y,67,'Estimated energy error'); 
else, eplot(error_tot,mv(:,1:4),xy,x(1:2:end),y(1:2:end),67,'Estimated energy error'); end
