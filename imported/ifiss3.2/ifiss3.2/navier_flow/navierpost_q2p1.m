function [error_x,error_y,fex,fey,ae] =... 
             navierpost_q2p1(viscosity,xy,mv,mbound,neumannb,q2p1sol,eex,hx,hy)
%NAVIERPOST_Q2P1 vectorized Q2-P1 error estimator 
%                          for Q2-P1 Navier-Stokes solution with Q3 error element
...
% Copyright (c) 2010 D.J. Silvester, Qifeng Liao 
      fprintf('Q2-P1 local N-S error estimator ...  ')
      x=xy(:,1); y=xy(:,2);
      mel=length(mv(:,1));
      error_x=zeros(mel,1);
      error_y=zeros(mel,1);
