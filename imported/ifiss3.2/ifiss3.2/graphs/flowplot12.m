function flowplot12(qmethod,sol,By,Bx,A,xy,xyp,x,y,bound,bndxy,bnde,obs,contourn,spc,fig)
%FLOWPLOT12 flow and element error on general domain
%   flowplot12(qmethod,xns,By,Bx,A,xy,xyp,x,y,bound,bndxy,bnde,obs,contourn,1,69)
%   input
...
%   IFISS function: HCE; DJS; 1 May 2012.
