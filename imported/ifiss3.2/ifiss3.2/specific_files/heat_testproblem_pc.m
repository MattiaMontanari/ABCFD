%HEAT_TESTPROBLEM_PC sets up Examples H1 to H3
...
system('copy .\timestepping\test_problems\heat1_bc.m .\diffusion\specific_bc.m');
   box_heat
elseif sn==2
system('copy .\diffusion\test_problems\zero_rhs.m .\diffusion\specific_rhs.m');
system('copy .\timestepping\test_problems\heat2_bc.m .\diffusion\specific_bc.m');
   ell_heat
elseif sn==3
system('copy .\diffusion\test_problems\zero_rhs.m .\diffusion\specific_rhs.m');
