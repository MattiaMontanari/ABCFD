function [error_x,error_y] = ...
          algpost_q2p1(q2p1sol,ae,xy,mv,mbound,neumannb,eex,hx,hy);
%ALGPOST_Q2P1 computes Q2-P1 error estimate inside iteration 
%              process for solving the algebraic system               
%   [error_x,error_y] = ...
%         algpost_q2p1(q2q1sol,ae,xy,mv,mbound,neumannb,eex,hx,hy);
%   input
%        q2p1sol        solution iterate  
...
%
%   calls function stressjmps_q2p1,  gausspoints_oned, gausspoints_twod
