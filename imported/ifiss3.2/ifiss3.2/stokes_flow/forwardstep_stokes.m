...
gohome
cd datafiles
save step_stokes_nobc.mat pde domain qmethod stretch A B Q f g xy xyp mbound bound x y 
save step_stokes_nobc.mat Bx By  -append
if qmethod==1 
   save step_stokes_nobc.mat C G ev ee ebound -append
elseif qmethod==0 
   save step_stokes_nobc.mat C G ev ee ebound mv enclosed -append
elseif qmethod==2
   save step_stokes_nobc.mat G mv mp -append
else
   save step_stokes_nobc.mat G mv  -append
end
