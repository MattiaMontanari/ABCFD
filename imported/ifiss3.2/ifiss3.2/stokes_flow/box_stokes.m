...
gohome
cd datafiles
save box_stokes_nobc.mat pde domain qmethod grid_type A B Q f g xy xyp mbound bound x y 
save box_stokes_nobc.mat Bx By  -append
if qmethod==1 
   save box_stokes_nobc.mat C G ev ee ebound -append
elseif qmethod==0 
   save box_stokes_nobc.mat C G ev ee ebound mv enclosed -append
elseif qmethod==2
   save box_stokes_nobc.mat mv mp G map -append
else
   save box_stokes_nobc.mat mv ee G -append
end
fprintf('system matrices saved in box_stokes_nobc.mat ...\n')
