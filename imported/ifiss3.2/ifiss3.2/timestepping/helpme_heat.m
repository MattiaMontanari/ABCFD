...
fprintf(' \n');
fprintf(' Nonzero boundary conditions are set in the\n');
fprintf(' user-defined function: /diffusion/specific_rhs.m\n'); 
fprintf(' \n');
fprintf(' Alternatively, simply run the driver: heat_testproblem\n');
fprintf(' \n');
