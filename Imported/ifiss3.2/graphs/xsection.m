function [uxref, uyref] = xsection(domain,qmethod,xy,xns,yyref,fig,mkr)
%XSECTION plots flow solution on horizontal X-section 
%   [uxref, uyref] = xsection(domain,qmethod,xy,xns,yyref,fig,'.b');
%   input
